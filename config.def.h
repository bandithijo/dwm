...
static const Rule rules[] = {
	...
	{ "St",                       NULL,                   "ncpamixer",				 0,          0,           1,           -1,          0 },
	{ "St",                       NULL,                   "pulsemixer",				 0,          0,           1,           -1,          0 },
...
static const char *outupvol[]    = { "pamixer-out.sh", "-i", "5", NULL };
static const char *outdownvol[]  = { "pamixer-out.sh", "-d", "5", NULL };
static const char *outmutevol[]  = { "pamixer-out.sh", "--toggle-mute", NULL };
static const char *inupvol[]    = { "pamixer-in.sh", "-i", "5", NULL };
static const char *indownvol[]  = { "pamixer-in.sh", "-d", "5", NULL };
static const char *inmutevol[]  = { "pamixer-in.sh", "--toggle-mute", NULL };
...
static const char *brightnessup[] = { "light.sh", "-A", "5", NULL };
static const char *brightnessdown[] = { "light.sh", "-U", "5", NULL };
static const char *clipmenu[] = { "clipmenu", NULL };
static const char *clipdel[] = { "clipdel", "-d", ".", NULL };
static const char *passlock[] = { "passtore", "0", NULL };
static const char *passcall[] = { "rofi-pass", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_space,  togglecanfocusfloating, {0} },
	{ MODKEY|Mod1Mask,			    XK_space,  resetcanfocusfloating, {0} },
	...
	{ MODKEY,                       XK_backslash,     spawn,   {.v = passlock } },
	{ MODKEY|ShiftMask,             XK_backslash,     spawn,   {.v = passcall } },
